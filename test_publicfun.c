...
static int Caldistancetolerance(
   int calDistance,
   int distance
   ) {
...
static void test_SwapNumTemplate(
   int a1,
   int b1
   ) {
  int a2 = a1, b2 = b1;
...
static void test_IsDoubleEqualTemplate(
   double x1,
   double x2,
   int isFalse
   ) {
...
static void test_IsDoubleEqualWithToleranceTemplate(
   double x1, double x2, double epsilon, int isFalse
   ) {
...
static void test_Angle2RadiansTemplate(
   double angle,
   double radians
   ) {
...
static void test_CalGpsDistanceTemplate(
   int lonFirst,
   int latFirst,
   int lonSecond,
   int latSecond,
...
static void test_CalGpsDistanceLonTemplate(
   int lonFirst,
   int latFirst,
   int lonSecond,
   int latSecond,
...
static void test_CalGpsDistanceLatTemplate(
   int lonFirst,
   int latFirst,
   int lonSecond,
   int latSecond,
...
static Suite *publicfun_suite(
  ...
  tcase_add_test( tc_core, test_SwapNum );
  tcase_add_test( tc_core, test_Angle2Radians );
